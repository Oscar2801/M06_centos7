https://github.com/Oscar2801/M06_centos7

#!/bin/bash

# This script creates a new user on local system.
# You must supply a username as an argument to the script.
# Optionally, you can also provode a comment for the acc as argument.
# A password will be auto generated for account.
# The username, password, and host for account will be displayed.
